            ...
            <div class="row">
                    ...
                    <div class="product-googles-info googles">
                        <div class="men-pro-item">
                            <div class="men-thumb-item">
                                <img src="{{ asset('frontend/images/s1.jpg') }}" class="img-fluid" alt=""  lazy="loading">
                ...
                <div class="col-md-3 product-men women_two">
                    <div class="product-googles-info googles">
                        <div class="men-pro-item">
                            <div class="men-thumb-item">
                                <img src="{{ asset('frontend/images/s2.jpg') }}" class="img-fluid" alt=""  lazy="loading">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="/single" class="link-product-add-cart">Quick View</a>
                                    </div>
                ...
                <div class="col-md-3 product-men women_two">
                    <div class="product-googles-info googles">
                        <div class="men-pro-item">
                            <div class="men-thumb-item">
                                <img src="{{ asset('frontend/images/s3.jpg') }}" class="img-fluid" alt=""  lazy="loading">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                ...
                <div class="col-md-3 product-men women_two">
                    <div class="product-googles-info googles">
                        <div class="men-pro-item">
                            <div class="men-thumb-item">
                                <img src="{{ asset('frontend/images/s4.jpg') }} " class="img-fluid" alt=""  lazy="loading">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
            ...
            <div class="row mt-lg-3 mt-0">
                ...
                <div class="col-md-3 product-men women_two">
                    <div class="product-googles-info googles">
                        <div class="men-pro-item">
                            <div class="men-thumb-item">
                                <img src="{{ asset('frontend/images/m1.jpg') }}" class="img-fluid" alt=""  lazy="loading">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                ...
                <div class="col-md-3 product-men women_two">
                    <div class="product-googles-info googles">
                        <div class="men-pro-item">
                            <div class="men-thumb-item">
                                <img src="{{ asset('frontend/images/m2.jpg') }}" class="img-fluid" alt=""  lazy="loading">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                ...
                <div class="col-md-3 product-men women_two">
                    <div class="product-googles-info googles">
                        <div class="men-pro-item">
                            <div class="men-thumb-item">
                                <img src="{{ asset('frontend/images/m3.jpg') }}" class="img-fluid" alt=""  lazy="loading">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                ...
                <div class="col-md-3 product-men women_two">
                    <div class="product-googles-info googles">
                        <div class="men-pro-item">
                            <div class="men-thumb-item">
                                <img src="{{ asset('frontend/images/m4.jpg') }}" class="img-fluid" alt=""  lazy="loading">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
