            ...
            <div class="about-content py-lg-5 py-3">
                <div class="row">
                    ...
                    <div class="col-lg-6 p-0">
                        <img src="{{ asset('frontend/images/banner1.jpg') }}" alt="Goggles" class="img-fluid">
                    </div>
                ...
                <div class="row mt-lg-5 mt-3">
                    <div class="col-md-3 team-main-gd">
                        <div class="team-grid text-center">
                            <div class="team-img">
                                <img class="img-fluid rounded" src="{{ asset('frontend/images/team1.jpg') }}" alt="">
                            </div>
                            <div class="team-info">
                                <h4>Partner 1</h4>
                 ...
                 <div class="col-md-3 team-main-gd">
                        <div class="team-grid text-center">
                            <div class="team-img">
                                <img class="img-fluid rounded" src="{{ asset('frontend/images/team2.jpg') }}" alt="">
                            </div>
                            <div class="team-info">
                                <h4>Partner 2</h4>
                                <span>Description </span>
                    ...
                    <div class="col-md-3 team-main-gd">
                        <div class="team-grid text-center">
                            <div class="team-img">
                                <img class="img-fluid rounded" src="{{ asset('frontend/images/team3.jpg') }}" alt="">
                            </div>
                            <div class="team-info">
                                <h4>Partner 3</h4>
                                <span>Description </span>
                    ...
                    <div class="col-md-3 team-main-gd">
                        <div class="team-grid text-center">
                            <div class="team-img">
                                <img class="img-fluid rounded" src="{{ asset('frontend/images/team4.jpg') }}" alt="">
                            </div>
                            <div class="team-info">
                                <h4>Partner 4</h4>
                                <span>Description </span>
            ...
            <div class="row galsses-grids pt-lg-5 pt-3">
                <div class="col-lg-6 galsses-grid-left">
                    <figure class="effect-lexi">
                        <img src="{{ asset('frontend/images/banner4.jpg') }}" alt="" class="img-fluid">
                        <figcaption>
                            <h3>Editor's
                                <span>Pick</span>
                            </h3>
                ...
                <div class="col-lg-6 galsses-grid-left">
                    <figure class="effect-lexi">
                        <img src="{{ asset('frontend/images/banner1.jpg') }}" alt="" class="img-fluid">
                        <figcaption>
                            <h3>Editor's
                                <span>Pick</span>
                            </h3>
